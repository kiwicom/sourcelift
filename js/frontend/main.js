  ...
  class Carousel {
    ...
    pause(event) {
      ...
      if ($(this._element).find(Selector.NEXT_PREV)[0] &&
        __WEBPACK_IMPORTED_MODULE_0__util__["a" /* default */].supportsTransitionEnd()) {
        __WEBPACK_IMPORTED_MODULE_0__util__["a" /* default */].triggerTransitionEnd(this._element)
        this.cycle(true)
      }
    ...
    _slide(direction, element) {
      ...
      if (__WEBPACK_IMPORTED_MODULE_0__util__["a" /* default */].supportsTransitionEnd() &&
        ...
        __WEBPACK_IMPORTED_MODULE_0__util__["a" /* default */].reflow(nextElement)

        $(activeElement).addClass(directionalClassName)
        $(nextElement).addClass(directionalClassName)

        $(activeElement)
          .one(__WEBPACK_IMPORTED_MODULE_0__util__["a" /* default */].TRANSITION_END, () => {
            $(nextElement)
